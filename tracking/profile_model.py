...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='DSATrack', choices=['DSATrack'],
                        help='training script name')
    parser.add_argument('--config', type=str, default='vitb_256_mae_32x4_ep300', help='yaml configure file name')
...
if __name__ == "__main__":
    ...
    args = parse_args()
    '''update cfg'''
    yaml_fname = '/home/gg/PythonProject/DSATrack-main/experiments/%s/%s.yaml' % (args.script, args.config)
