...
class LaSOTDataset(BaseDataset):
    ...
    def _construct_sequence(self, sequence_name):
        ...
        anno_path = '{}/{}/{}/groundtruth.txt'.format(self.base_path, sequence_name, sequence_name)

        ground_truth_rect = load_text(str(anno_path), delimiter=',', dtype=np.float64)

        occlusion_label_path = '{}/{}/{}/full_occlusion.txt'.format(self.base_path, sequence_name, sequence_name)
        ...
        out_of_view_label_path = '{}/{}/{}/out_of_view.txt'.format(self.base_path, sequence_name, sequence_name)
        ...
        frames_path = '{}/{}/{}/img'.format(self.base_path, sequence_name, sequence_name)
