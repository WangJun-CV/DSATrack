...
def main():
    ...
    parser.add_argument('--script', type=str, default="DSATrack", required=False, help='Name of the train script.')
    parser.add_argument('--config', type=str, default='vitb_256_mae_ce_32x4_ep300', required=False, help="Name of the config file.")
    parser.add_argument('--cudnn_benchmark', type=bool, default=True, help='Set cudnn benchmark on (1) or off (0) (default is on).')
    parser.add_argument('--local_rank', default=-1, type=int, help='node rank for distributed training')
    parser.add_argument('--save_dir', type=str, default='/home/gg/PythonProject/DSATrack-main/checkpoints', help='the directory to save checkpoints and logs')
