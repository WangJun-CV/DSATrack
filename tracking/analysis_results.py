...
"""DSATrack"""
trackers.extend(trackerlist(name='DSATrack', parameter_name='vitb_256_mae_ce_32x4_ep300', dataset_name=dataset_name,
                            run_ids=None, display_name='DSATrack256'))
# trackers.extend(trackerlist(name='DSATrack', parameter_name='vitb_384_mae_ce_32x4_ep300', dataset_name=dataset_name,
#                             run_ids=None, display_name='DSATrack384'))
