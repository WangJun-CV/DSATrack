...
def parse_args():
    ...
    parser.add_argument("--workspace_dir", type=str, default='/home/gg/PythonProject/DSATrack-main', required=False)  # workspace dir
    parser.add_argument("--data_dir", type=str, default='/media/gg/data/datasets', required=False)
    parser.add_argument("--save_dir", type=str, default='/home/gg/PythonProject/DSATrack-main/tracking_results', required=False)
